...
function copyCode(e) {
  ...
  window.getSelection().removeAllRanges(),
    e.parentElement.querySelector(".alert") ||
      ...
      (o.style.opacity = "0"),
      (o.style.transition = ".35s ease"),
      setTimeout(function () {
        (o.style.transform = "translate3d(0px, 20px, 0px)"),
          o.style.setProperty("opacity", "1", "important");
      }, 100),
      (o.innerHTML = "Code successfully copied!"),
...
total.forEach(function (a, e) {
  ...
  if (
    ((n.style.padding = "0px"),
    (n.style.width = a.querySelector("li .nav-link.active").offsetWidth + "px"),
    a.classList.contains("flex-column"))
  ) {
    for (var s = 1; s < r; s++)
      i += a.querySelector("li:nth-child(" + s + ")").offsetHeight;
    n.style.transform = "translate3d(0px," + i + "px, 0px)";
  } else {
    for (s = 1; s < r; s++)
      i += a.querySelector("li:nth-child(" + s + ")").offsetWidth;
